...
widget1.place(bordermode=OUTSIDE, height=100, width=500, x=300)
label = Label(widget1,text="Projeto cg 2!", bg="white")
label["font"] = ("Verdana", "20", "italic", "bold")
label.pack()


btnReta= Button(master,text="Retas",command=renderReta,bg="#3D86FC",fg="white",width=13)
btnReta.place(x=400,y=100)
btnReta["font"] = ("Verdana", "10", "italic", "bold")
btnCircunferencia = Button(master,text="Circunferencias",command=renderCircunferencia,bg="#3D86FC",fg="white"
                           ,width=13)
btnCircunferencia.place(x=600,y=100)
